...
import com.example.fueldeliveryapp.adapters.MenuListAdapter;
...
public class MainFuelActivity extends AppCompatActivity implements MenuListAdapter.MenuListClickListener {
        ...
        buttonCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemsInCartList != null && itemsInCartList.size() <= 0) {
                    Toast.makeText(MainFuelActivity.this, "Please add some items in cart.", Toast.LENGTH_SHORT).show();
                    return;
                }

                fuelModal.setMenus(itemsInCartList);
                Intent i = new Intent(MainFuelActivity.this, PlaceOrderActivity.class);
                i.putExtra("fuelmodel", fuelModal);
